      ...
      <div className="max-w-screen-lg mx-auto p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-6">
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-4  mt-4 text-xs sm:text-sm text-gray-700 text-center">
              <p className="hidden sm:block font-medium">Product</p>
              <p className="hidden sm:block font-medium  pl-36">Price</p>
              <p className="hidden sm:block font-medium pl-32">Subtotal</p>
            </div>
            {cartItems.length === 0 ? (
              ...
              cartItems.map((item) => (
                <div
                  key={item.product.id}
                  className="grid grid-cols-4 mt-4 items-center text-gray-800"
                >
